...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2022 a las 04:34:32
...
INSERT INTO `catbeneficiario` (`id`, `nombreApellido`, `fnacimiento`, `direccion`, `celular`, `telefono`, `referencia`, `tipoMedio`, `estadoMedio`, `apoyoMedio`, `diagnostico`, `foto`, `nombreTutor`, `cedula`, `parentesco`, `fechaCreacion`, `fechaBaja`, `fechaAtendidos`) VALUES
(1, 'Gerald Canales', '2000-02-05', 'Managua, Nicaragua', '81234567', '22651234', 'Ana Jarquin', 'Silla de Ruedas', 'Problema con Medidas', 'Total', 'diagnostico1', 'app/vista/img/beneficiario/b693.png', 'Daril Garcia', '001-234567-0007E', 'tio', '2022-04-23', NULL, NULL),
(2, 'Marvin', '2016-01-07', 'Managua', '81234567', '227654321', 'Daril', 'No Tengo', 'No Tengo', 'No Aplica', 'diagnostico1', 'app/vista/img/beneficiario/b186.png', 'Juan Castellon', '001-01011993-0087L', 'padre', '2022-04-23', NULL, NULL);
